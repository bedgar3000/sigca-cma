			...
			<td width="50%" valign="top">
	        	<table width="100%">
	            	...
	            	<tr>
	                    ...
	                    <td><input type="text" id="FechaRegistro" value="<?=formatFechaDMA($field_obligacion['FechaRegistro'])?>" style="width:100px;" class="datepicker codigo" onkeyup="setFechaDMA(this);" onchange="setPresupuesto($('#CodOrganismo').val(), $(this).val(), $('#CodPresupuesto'), $('#Anio'), $('#CategoriaProg').val()); actualizarMontosObligacion();" <?=$disabled_ver?> /></td>
	                </tr>
	            	<tr>
